...
from acm_eval import run_eval_suite  # noqa: E402
from acm_eval.config import SUPPORTED_ANALYSES, SUPPORTED_SIMULATORS  # noqa: E402
...
def main() -> None:
    ...
    parser.add_argument(
        "--config",
        type=Path,
        default=ROOT / "config/eval_suite.json",
    ...
    reports = write_regression_reports(repo_root=ROOT, results_dir=args.results_dir)
